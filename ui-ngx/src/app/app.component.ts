...
// 项目根组件下的根模块，采用typeScript方式写js. 
@Component({
  selector: 'tb-root',                    //关联HTML中的标签，当html解析到tb-root时，该标签背后的动作就是由该组件控制的
  templateUrl: './app.component.html',    //模板的html,当解析到tb-root时，将tb-root标签替换成该html代码
...
export class AppComponent implements OnInit {
  ...
  constructor(private store: Store<AppState>,
    ...
    console.log(`Kale Version: ${env.tbVersion}`);
